...
### 👨‍💻 Sobre
Atualmente cursando o [Ciência da Computação] período Noite [Nome do Curso] na [Nome da Instituição unicid]. Trabalho na area de técnologia e gosto de resolver problemas através da tecnologia e possuo foco em [Segurança eletronica - ex: Desenvolvimento Backend / Análise de Dados].
