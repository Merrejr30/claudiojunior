...
- **CJR Assistência Técnica**  
  *Administrador (PJ)*  
  Responsável pela gestão da empresa, execução de projetos técnicos, atendimento a clientes e coordenação de serviços de instalação e manutenção.

- **ATTO**  
  *Supervisor de Campo / Analista de Segurança*  
  Atuação na supervisão de equipes técnicas, acompanhamento de atividades em campo e suporte em projetos de segurança eletrônica.

- **Diprosseg**  
  *Técnico em Sistemas de Segurança*  
  Instalação e manutenção de sistemas de CFTV, controle de acesso e automação de portarias.

- **Itaú / Santander (via prestadora RC4 Azul)**  
  *Analista de Segurança*  
  Atuação em ambiente corporativo bancário, realizando:
  - Implantação e manutenção de sistemas de monitoramento (CFTV)
  - Diagnóstico e resolução de falhas técnicas
  - Configuração de equipamentos (NVR, câmeras IP)
  - Integração com sistemas de monitoramento (Intelbras Defense)

- **CBMS / Grupo Sparta / Security Dynamics**  
  *Analista de Segurança / Prestador de Serviços*  
  Execução de atividades técnicas relacionadas à segurança eletrônica, redes e infraestrutura.

- **Global Tecnologia**  
  *Supervisor Técnico / Coordenador Técnico*  
  Coordenação de equipes, planejamento de projetos e suporte técnico especializado.

- **Fortex**  
  *Técnico em Segurança Eletrônica*  
  Instalação e manutenção de sistemas de segurança.

- **Outras Empresas (Alarmin, AGT, TESB, LPM, Martom)**  
...
- Configuração de NVR/DVR e câmeras IP
- Controle de acesso e portaria eletrônica
- Automação de portões e sistemas de segurança
...
- **SENAI**  
  Curso: Elétrica Residencial e Predial  

- **SENAC**  
  Curso: Informática  

- **Voice Data**  
  Curso: Energia Solar, CFTV IP, Portaria Eletrônica, Controle de Acesso e Alarmes  

- **Diprosseg**  
  Curso: Sistemas Hikvision (CFTV IP), Controle de Acesso e Motores de Portão PPA  
...
- Monitoramento remoto de condomínios
